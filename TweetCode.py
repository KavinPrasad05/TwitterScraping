        ...
        if submit_button:
            ...
            for tweet in sntwitter.TwitterSearchScraper(f'from:{query} since:{start} until:{end}').get_items():
                ...
                # Stores the tweet data into MongoDB until the limit is reached
                    ...
                    new = {"date": tweet.date, "user": tweet.user.username, "url": tweet.url,"ReplyCount":tweet.replyCount,
                           "Language": tweet.lang,"LikeCount": tweet.likeCount,"Tweet ID": tweet.id,"Text": tweet.content
                           }
